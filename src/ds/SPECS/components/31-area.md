...
> Spec 31 · grupo: `charts` · referência visual: `reference-html/Component - Area Chart.html`

## Resumo

Line chart com fill abaixo. Single, stacked, percent. Smooth curve opcional. Mesmo tooltip pattern do Line.
...
1. **Abra o HTML de referência** em `reference-html/Component - Area Chart.html` no navegador.
