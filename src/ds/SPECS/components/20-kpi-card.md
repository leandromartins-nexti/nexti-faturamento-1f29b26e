...
> Spec 20 · grupo: `containers` · referência visual: `reference-html/KPI Card.html`

## Resumo

Card de métrica. Slots: label (top, ink-500 eyebrow), value (display weight 800, navy-700, tnum), delta (DeltaPill), sparkline opcional, footer meta opcional. Sizes: sm/md/lg. Loading via Skeleton.

## Onde fica

`src/components/containers/KPICard/`
...
1. **Abra o HTML de referência** em `reference-html/KPI Card.html` no navegador.
