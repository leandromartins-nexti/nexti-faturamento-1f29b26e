...
> Spec 30 · grupo: `charts` · referência visual: `reference-html/Component - Donut Pie Chart.html`

## Resumo

Donut (default, com inner radius) ou pie. Center label slot (donut). Legend (right ou bottom). Hover highlight + tooltip.

## Onde fica

`src/components/charts/DonutPie/`
...
1. **Abra o HTML de referência** em `reference-html/Component - Donut Pie Chart.html` no navegador.
...
```tsx
import { DonutPie } from '@/components';
