# Foundation · Elevation, Motion & Icons

> Foundation doc · referência: `reference-html/Foundation - Elevation, Motion & Iconography.html`

## Resumo

Shadow tiers (xs..xl, brand). Easing curves + duration tokens. Icon system (Lucide React, sizes 14/16/20/24).
