...
> Spec 02 · grupo: `primitives` · referência visual: `reference-html/Component - Input.html`

## Resumo

Text input with label, hint, error, leftIcon/rightIcon, prefix/suffix, sizes (sm/md/lg). States: default, focus, hover, error, disabled, readonly. Use native <input>; wrap in label component for a11y.
...
1. **Abra o HTML de referência** em `reference-html/Component - Input.html` no navegador.
