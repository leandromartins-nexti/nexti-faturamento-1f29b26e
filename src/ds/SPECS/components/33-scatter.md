...
> Spec 33 · grupo: `charts` · referência visual: `reference-html/Component - Scatter Chart.html`

## Resumo

XY plot. Optional size (bubble) e color por categoria. Quadrant lines via prop {x, y, labels}. Trendline opcional.
...
1. **Abra o HTML de referência** em `reference-html/Component - Scatter Chart.html` no navegador.
