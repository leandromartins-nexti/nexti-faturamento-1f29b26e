...
> Spec 36 · grupo: `charts` · referência visual: `reference-html/15 - Component - Waterfall.html`

## Resumo

Bar chart de variações cumulativas. Bars positivos (verde) + negativos (vermelho) + totais (navy). Connector lines entre barras.

## Onde fica

`src/components/charts/Waterfall/`
...
1. **Abra o HTML de referência** em `reference-html/15 - Component - Waterfall.html` no navegador.
