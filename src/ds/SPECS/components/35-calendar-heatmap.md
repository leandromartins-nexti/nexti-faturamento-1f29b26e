...
> Spec 35 · grupo: `charts` · referência visual: `reference-html/18 - Component - Calendar Heatmap.html`

## Resumo

GitHub-style. Year view (52 cols × 7 rows). Month labels topo, weekday labels esquerda. Color scale por valor.
...
1. **Abra o HTML de referência** em `reference-html/18 - Component - Calendar Heatmap.html` no navegador.
