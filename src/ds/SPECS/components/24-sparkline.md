...
> Spec 24 · grupo: `charts` · referência visual: `reference-html/14 - Component - Sparkline.html`

## Resumo

Mini line chart sem eixos. Apenas data. Optional last-point marker. Variants: line, area, bars. Color via prop ou auto pelo trend (up/down).

## Onde fica

`src/components/charts/Sparkline/`
...
1. **Abra o HTML de referência** em `reference-html/14 - Component - Sparkline.html` no navegador.
