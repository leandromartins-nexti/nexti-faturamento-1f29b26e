...
> Spec 27 · grupo: `charts` · referência visual: `reference-html/Component - Line Chart.html`

## Resumo

Multi-series line chart. Smooth (curve) opcional. Markers opcional. Crosshair tooltip (vertical line + dot por série). Y formatter prop. Eixo X data ou category.
...
1. **Abra o HTML de referência** em `reference-html/Component - Line Chart.html` no navegador.
