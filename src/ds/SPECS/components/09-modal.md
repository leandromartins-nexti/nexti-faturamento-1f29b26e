...
> Spec 09 · grupo: `primitives` · referência visual: `reference-html/Component - Modal.html`

## Resumo

Radix Dialog. Sizes (sm 480 / md 640 / lg 800 / xl full). Header slot, body slot, footer slot. Confirmation pattern (title + body + 2 buttons). Focus trap automático.

## Onde fica

`src/components/primitives/Modal/`
...
1. **Abra o HTML de referência** em `reference-html/Component - Modal.html` no navegador.
