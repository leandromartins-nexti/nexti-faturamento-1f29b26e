...
> Spec 06 · grupo: `primitives` · referência visual: `reference-html/Component - Date Picker.html`

## Resumo

Single + range mode. Calendar in Radix Popover. Quick-presets (Hoje, Últimos 7d, MTD, etc). pt-BR locale via date-fns. Min/max constraints, disabled dates fn.
...
1. **Abra o HTML de referência** em `reference-html/Component - Date Picker.html` no navegador.
