...
> Spec 29 · grupo: `people` · referência visual: `reference-html/20 - Component - Avatar.html`

## Resumo

Imagem circular. Fallback: iniciais (gerar de "Nome Sobrenome"). Sizes: xs(24)/sm(32)/md(40)/lg(56)/xl(72). Status dot opcional. Group (overlapping stack) variant.

## Onde fica

`src/components/people/Avatar/`
...
1. **Abra o HTML de referência** em `reference-html/20 - Component - Avatar.html` no navegador.
