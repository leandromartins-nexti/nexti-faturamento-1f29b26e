...
> Spec 03 · grupo: `primitives` · referência visual: `reference-html/Component - Textarea.html`

## Resumo

Multiline text. Same shell/hint/error pattern as Input. Auto-grow option. Counter (chars left) when maxLength is set.

## Onde fica

`src/components/primitives/Textarea/`
...
1. **Abra o HTML de referência** em `reference-html/Component - Textarea.html` no navegador.
