...
> Spec 32 · grupo: `charts` · referência visual: `reference-html/Component - Combo Chart.html`

## Resumo

Bar + Line combinados. 2 eixos Y opcionais. Útil para volume + ratio (ex: leads × conversão).

## Onde fica

`src/components/charts/ComboChart/`
...
1. **Abra o HTML de referência** em `reference-html/Component - Combo Chart.html` no navegador.
...
```tsx
import { ComboChart } from '@/components';
