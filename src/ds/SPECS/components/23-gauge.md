...
> Spec 23 · grupo: `charts` · referência visual: `reference-html/11 - Component - Gauge v1.3.html`

## Resumo

Semi-circular ou full-circle gauge. Thresholds via array de zonas {min, max, color}. Pointer + valor central + labels. SVG puro com arc paths.

## Onde fica

`src/components/charts/Gauge/`
...
1. **Abra o HTML de referência** em `reference-html/11 - Component - Gauge v1.3.html` no navegador.
