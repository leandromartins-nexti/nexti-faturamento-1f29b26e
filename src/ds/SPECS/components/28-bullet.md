...
> Spec 28 · grupo: `charts` · referência visual: `reference-html/19 - Component - Bullet Chart.html`

## Resumo

Single value + target line + thresholds (qualitative ranges). Compact (35px) ou full (60px). Horizontal por padrão.

## Onde fica

`src/components/charts/BulletChart/`
...
1. **Abra o HTML de referência** em `reference-html/19 - Component - Bullet Chart.html` no navegador.
...
```tsx
import { BulletChart } from '@/components';
