...
> Spec 04 · grupo: `primitives` · referência visual: `reference-html/Component - Select.html`

## Resumo

Dropdown built on Radix Select. Single + multi (multi via custom popover with checkboxes). Searchable variant for >10 options. Async data via render prop. Same shell as Input.
...
1. **Abra o HTML de referência** em `reference-html/Component - Select.html` no navegador.
