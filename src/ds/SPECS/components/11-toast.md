...
> Spec 11 · grupo: `primitives` · referência visual: `reference-html/Component - Toast.html`

## Resumo

Radix Toast. 4 intents (info/success/warning/danger). Title + description + action button + dismiss. Hook useToast() para chamada imperativa: toast({ title, description, intent, action }).
...
1. **Abra o HTML de referência** em `reference-html/Component - Toast.html` no navegador.
