...
> Spec 10 · grupo: `primitives` · referência visual: `reference-html/Component - Tooltip.html`

## Resumo

Radix Tooltip. Side (top/right/bottom/left), align, delay. Arrow opcional. Para tooltips ricas com formatação, use shorthand <Tooltip content="..."><Trigger /></Tooltip>.
...
1. **Abra o HTML de referência** em `reference-html/Component - Tooltip.html` no navegador.
