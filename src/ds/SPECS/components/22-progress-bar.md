...
> Spec 22 · grupo: `charts` · referência visual: `reference-html/Component - Progress Bar.html`

## Resumo

Linear progress 0–100. Variants: default, success, warning, danger. Indeterminate (animated stripe). With label/value. Stacked variant (segments).

## Onde fica

`src/components/charts/ProgressBar/`
...
1. **Abra o HTML de referência** em `reference-html/Component - Progress Bar.html` no navegador.
