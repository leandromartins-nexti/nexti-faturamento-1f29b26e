...
> Spec 26 · grupo: `charts` · referência visual: `reference-html/Component - Bar Chart Horizontal.html`

## Resumo

Mesmo que vertical mas eixos invertidos. Bom para muitas categorias e para ranking. Auto-sort opcional.

## Onde fica

`src/components/charts/BarChartHorizontal/`
...
├── BarChartHorizontal.stories.tsx
├── BarChartHorizontal.test.tsx
└── index.ts
```

## Como implementar

1. **Abra o HTML de referência** em `reference-html/Component - Bar Chart Horizontal.html` no navegador.
