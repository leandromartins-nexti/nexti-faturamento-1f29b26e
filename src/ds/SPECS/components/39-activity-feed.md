...
> Spec 39 · grupo: `people` · referência visual: `reference-html/22 - Component - Activity Feed.html`

## Resumo

Timeline vertical. Itens: Avatar + ator + ação (texto rico) + timestamp + opcional payload (card embed). Group by day. Load more pattern.

## Onde fica

`src/components/people/ActivityFeed/`
...
1. **Abra o HTML de referência** em `reference-html/22 - Component - Activity Feed.html` no navegador.
