...
> Spec 08 · grupo: `primitives` · referência visual: `reference-html/Component - Tabs.html`

## Resumo

Radix Tabs. Two variants: underline (default) and pills. Keyboard nav, ARIA correct. Icon + label per tab. Optional badge count.
...
1. **Abra o HTML de referência** em `reference-html/Component - Tabs.html` no navegador.
