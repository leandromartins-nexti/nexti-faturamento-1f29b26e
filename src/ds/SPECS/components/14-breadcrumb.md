...
> Spec 14 · grupo: `primitives` · referência visual: `reference-html/Component - Breadcrumb.html`

## Resumo

Nav breadcrumb. Itens via array prop ou children. Separator customizável (default chevron). Truncate middle quando >4 itens. asChild para Link integration.

## Onde fica

`src/components/primitives/Breadcrumb/`
...
1. **Abra o HTML de referência** em `reference-html/Component - Breadcrumb.html` no navegador.
