...
> Spec 01 · grupo: `primitives` · referência visual: `reference-html/Component - Button.html`

## Resumo

Primary interactive element. 5 variants (primary, secondary, outline, ghost, danger), 3 sizes (sm/md/lg), block, loading, leftIcon/rightIcon, asChild via Radix Slot. Already implemented in starter as reference.
...
1. **Abra o HTML de referência** em `reference-html/Component - Button.html` no navegador.
