...
> Spec 37 · grupo: `charts` · referência visual: `reference-html/17 - Component - Sankey.html`

## Resumo

Fluxo entre nós. Nodes em colunas (auto-layered) + flows como bezier paths. Hover destaca caminho. Click para drill-down (callback).

## Onde fica

`src/components/charts/Sankey/`
...
1. **Abra o HTML de referência** em `reference-html/17 - Component - Sankey.html` no navegador.
