...
> Spec 38 · grupo: `people` · referência visual: `reference-html/21 - Component - People List.html`

## Resumo

Tabela compacta de pessoas. Linhas: Avatar + nome + role + meta (right-aligned). Click action por linha. Empty state. Loading via Skeleton.

## Onde fica

`src/components/people/PeopleList/`
...
1. **Abra o HTML de referência** em `reference-html/21 - Component - People List.html` no navegador.
...
- [ ] Re-export adicionado em `src/components/people/index.ts`
