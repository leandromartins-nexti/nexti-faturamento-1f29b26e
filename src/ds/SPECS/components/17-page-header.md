...
> Spec 17 · grupo: `primitives` · referência visual: `reference-html/Component - Page Header.html`

## Resumo

Cabeçalho padrão de página. Slots: breadcrumb (top), title, description, actions (buttons à direita), tabs (bottom optional). Sticky variant.

## Onde fica

`src/components/primitives/PageHeader/`
...
1. **Abra o HTML de referência** em `reference-html/Component - Page Header.html` no navegador.
