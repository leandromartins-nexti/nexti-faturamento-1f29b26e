...
> Spec 34 · grupo: `charts` · referência visual: `reference-html/16 - Component - Heatmap.html`

## Resumo

Matriz com células coloridas por intensidade. Color scale via prop (sequencial single-hue ou diverging). Row/col labels. Hover tooltip.
...
1. **Abra o HTML de referência** em `reference-html/16 - Component - Heatmap.html` no navegador.
