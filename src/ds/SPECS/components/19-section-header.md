...
> Spec 19 · grupo: `containers` · referência visual: `reference-html/Component - Section Header v1.2.html`

## Resumo

Divider entre seções. Eyebrow numerado + título + opcional descrição + opcional rule line. Variantes: with-num (eyebrow+orange), inline (sem rule), centered.

## Onde fica

`src/components/containers/SectionHeader/`
...
1. **Abra o HTML de referência** em `reference-html/Component - Section Header v1.2.html` no navegador.
